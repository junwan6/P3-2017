...
<html>
      ...
      <?php include 'partials/global_header.php'?>
			<script type="text/javascript" language="javascript" src="static/browse.js"></script>
			<link type="text/css" rel="stylesheet" href="static/browse.css">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                              <div class="box">
                                ...
                                <div class="panel-group" id="browseAccordion" role="tablist" aria-multiselectable="true">
                                  <!-- {{> major_group }} -->
                                  <?php include "partials/major_group.html"?>
                                  ...
                                  <div class="panel panel-default majorSection">
                                    ...
                                    <div id="worldOfWorkOptions" class="panel-collapse collapse" role="tab-panel">
                                      <img id="world-of-work" src="static/images/wow.png" alt="World of Work" align="center" width="540px" height="auto">
                                    </div>
                                  </div>
                                </div>
                              </div>
